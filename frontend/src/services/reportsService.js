...
export const getWeeklyReport = (businessId = BUSINESS_ID) =>
  api.get(`/api/v1/businesses/${businessId}/reports/weekly`).then((r) => r.data);

/** Get monthly report */
export const getMonthlyReport = (businessId = BUSINESS_ID) =>
  api.get(`/api/v1/businesses/${businessId}/reports/monthly`).then((r) => r.data);

/** Get quarterly report */
export const getQuarterlyReport = (businessId = BUSINESS_ID) =>
  api.get(`/api/v1/businesses/${businessId}/reports/quarterly`).then((r) => r.data);
