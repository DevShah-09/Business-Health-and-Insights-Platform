...
import { IndianRupee, Mail, Lock, User, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[var(--color-surface)] p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="p-8 backdrop-blur-md bg-surface-card/80 border-surface-border/30">
          <h2 className="text-2xl font-bold text-surface-foreground mb-2">Create an account</h2>
          <p className="text-surface-muted-foreground text-sm mb-8">Start your journey with intelligent insights</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-surface-muted-foreground" size={18} />
                <input
                  type="text"
                  required
                  value={fullName}
